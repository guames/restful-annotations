package com.guames.restfulapi.access;
...
public class DataAccessFieldCallback implements ReflectionUtils.FieldCallback {
    ...
    private static String ERROR_ENTITY_VALUE_NOT_SAME = "@AbstractDAO(entity) "
            + "value should have same type with injected generic type.";
    private static String WARN_NON_GENERIC_VALUE = "@AbstractDAO annotation assigned "
    ...
    public void doWith(Field field)
        ...
        if (!field.isAnnotationPresent(AbstractDAO.class)) {
            return;
        }
        ...
        Class<?> classValue = field.getDeclaredAnnotation(AbstractDAO.class).entity();
